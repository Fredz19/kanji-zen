...
import { Flame, Clock, Target, Play, ShieldAlert, BookOpen, Edit3, Award, Zap, HelpCircle, Layers, FileUp, Download, Eye, LogOut, Shield, Settings, Book } from 'lucide-react';
